...
class ReferralsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create referral" do
    assert_difference('Referral.count') do
      post referrals_url, params: { referral: { contact_person: @referral.contact_person, institution: @referral.institution, position: @referral.position } }
    end
  ...
  test "should update referral" do
    patch referral_url(@referral), params: { referral: { contact_person: @referral.contact_person, institution: @referral.institution, position: @referral.position } }
